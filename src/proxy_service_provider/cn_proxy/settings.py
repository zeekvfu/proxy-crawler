...
BOT_NAME = 'cn_proxy_spider'
SPIDER_MODULES = ['proxy_service_provider.cn_proxy.spiders']
NEWSPIDER_MODULE = 'proxy_service_provider.cn_proxy.spiders'
...
ITEM_PIPELINES = {
        'proxy_service_provider.cn_proxy.pipelines.ETL': 0
        }

...
BOT_NAME = 'mimvp_spider'
SPIDER_MODULES = ['proxy_service_provider.mimvp.spiders']
NEWSPIDER_MODULE = 'proxy_service_provider.mimvp.spiders'
...
ITEM_PIPELINES = {
        'proxy_service_provider.mimvp.pipelines.ETL': 0
        }

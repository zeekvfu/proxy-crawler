...
BOT_NAME = 'xicidaili_spider'
SPIDER_MODULES = ['proxy_service_provider.xicidaili.spiders']
NEWSPIDER_MODULE = 'proxy_service_provider.xicidaili.spiders'
...
ITEM_PIPELINES = {
        'proxy_service_provider.xicidaili.pipelines.ETL': 0
        }
